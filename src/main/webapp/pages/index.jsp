		...
		<main class="main-content">
			<div class="container">
				<div class="page">
					<div class="row">
					<!--  
						<c:forEach items="${index}" var="pelicula">
					...
					-->
							...
							<div class="slider">
								<ul class="slides">
									<c:forEach items="${peliculas}" var="pelicula">
										<li><a href="pelicula/${pelicula.id}"><img src="http://image.tmdb.org/t/p/original/${pelicula.posterPath}" alt="${pelicula.title}"></a></li>
									</c:forEach>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-6">
							<h1 class="movie-title">Series</h1>
							<div class="slider">
								<ul class="slides">
									<c:forEach items="${series}" var="serie">
										<li><a href="serie/${serie.id}"><img src="http://image.tmdb.org/t/p/original/${serie.posterPath}" alt="${serie.name}"></a></li>
									</c:forEach>
								</ul>
							</div>
						</div>					
