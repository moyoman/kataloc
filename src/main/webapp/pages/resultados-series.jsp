	...
	<div id="site-content">
		...
		<main class="main-content">
			<div class="container">
				<div class="page">
					<div class="row">
						<h1 class="movie-title"> Serie Search Results</h1>
						<c:forEach items="${search}" var="serie">
							<div class="col-sm-6 col-md-3">
								<div class="latest-movie">
									<a href="serie/${serie.id}"><img src="http://image.tmdb.org/t/p/original/${serie.posterPath}" alt="${serie.name}"></a>
								</div>
							</div>
						</c:forEach>
					</div>
