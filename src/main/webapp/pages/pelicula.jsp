	...
	<div id="site-content">
		...
		<main class="main-content">
				<div class="container">
					<div class="page">
						<div class="filters">
							<form method="POST" action="peliculas" id="filtro">
								...
								<div class="movie">
									<figure class="movie-poster">
										<a href="../pelicula/${pelicula.id}">
											<img src="http://image.tmdb.org/t/p/original/${pelicula.posterPath}" alt="${pelicula.title}">
										</a>
									</figure>
									<div class="movie-title"><a href="../pelicula/${pelicula.id}">${pelicula.title}</a></div>
